...
See the [components](components.qmd) page for details on the main components in a surveydown survey, like. For a quick overview, here's how you add pages and questions:
