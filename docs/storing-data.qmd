...
By default, the data on each page will be locally stored in the browser cookies, though you can turn this feature off if you wish (see [here](docs/survey-settings.html#cookies)). 
