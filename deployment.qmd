...
3. You have set up a [Supabase]({{< var url_supabase >}}) project and have already added the database parameters in the `sd_database()` function in the setup code chunk (see the [Store Data](store-data.qmd) page for details).
...
5. You have created an account on [shinyapps]({{< var url_shinyapps >}}), which will be used for survey online deployment.
