...
1. Design your survey as a [Quarto]({{< var url_quarto >}}) document using markdown and R code.
2. Convert your survey into a [Shiny]({{< var url_shiny >}}) app that can be hosted online and sent to respondents.
3. Store your survey responses in a [Supabase]({{< var url_supabase >}}) database (or any Postgres database).
