...
Deploy your survey by hosting it on your favorite server, like {{< var shinyapps >}}, {{< var huggingface >}}, etc. See the [Deployment](deployment.qmd) page for more details.
