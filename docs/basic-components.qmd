...
::: {.callout-note}
If you are using {{< var rstudio_ide >}}, you can see the addins of "Add Survey Page" and "Add Survey Question" in your **Addins** menu. You can trigger the addin from the dropdown menu, or define keyboard shortcuts to easily trigger them. This will speed up your survey construction.
:::
