...
The short-hand format `c("Label 1", "Label 2")` is also supported, in which case the values will be the snake case version of the labels (e.g., `"Label 1"` becomes `"label_1"`).
