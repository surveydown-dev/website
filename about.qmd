...
![](/images/authors/john-helveston-square.png){style="width: 200px; border-radius: 50%;"}
...
![](/images/authors/pingfan-hu.jpg){style="width: 200px; border-radius: 50%;"}
...
![](/images/authors/bogdan-bunea.jpg){style="width: 200px; border-radius: 50%;"}
