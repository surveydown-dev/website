...
In addition, [`matrix`](question-types.html#matrix) type questions have two additional size arguments:

- `matrix_question_width`
- `matrix_option_width`

These set the relative widths of the question and option parts of `matrix` questions. You should set them to a percentage, such as `"40%"`, for example.
