...
On the connection page, scroll down to the "Transaction pooler" section. There you can click on the "View parameters" drop down to see your connection parameters. It should look something like this:
