...
image: banners/10_live_polling.png
description: "A [reactive](docs/reactivity.html) question template of live-polling with responses shown as a bar chart."
---

Call `sd_create_survey(format = "live_polling")` to create this template. Refer to the [Start with a template](/docs/getting-started.html#start-with-a-template) section for more details.
