...
| <i class="fa fa-shuffle" aria-hidden="true"></i> | random-labels-preset | A demo of how to implement [predefined random labels](reactivity.html#pre-defined-randomization). |
