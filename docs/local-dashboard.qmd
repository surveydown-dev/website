...
With the **sdstudio** package, you can launch the **surveydown studio**. It is a local shiny app that provides a variety of extended capabilities that support **surveydown**. For a full introduciton to the surveydown studio, proceed to our blog post [Introducing sdstudio: A companion GUI for surveydown](/blog/2025-06-29-sdstudio/index.html).
