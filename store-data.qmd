...
The surveydown package is designed to work with any PostgreSQL database. Since many may not want to create such a database on their own, we recommend using [Supabase]({{< var url_supabase >}}), which is a free, open-source PostgreSQL database service.
