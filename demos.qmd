...
df <- data.frame(
  ...
  description = c(
    ...
    "A demo of how to implement [conditional display](conditional-control.html#conditional-display) (showing a question based on a previous response).",
    "A demo of how to implement [conditional skipping](conditional-control.html#conditional-skipping) (skipping to a page based on a previous response).",
  ...
  demo_url = c(
    ...
    "https://youtu.be/xVSrjHcEh3g",
    "https://youtu.be/iVxktJiDi1s",
    "https://youtu.be/pCUKCwzJpCc"
  ),
  demo_type = c(
    "survey",
    "survey",
