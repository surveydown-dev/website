...
::: {.callout-note}
This is a quick guide for surveydown setup. Proceed to [Basic Components](basic-components.qmd) to learn about the main components of your survey.
:::
...
Survey content is edited in the **survey.qmd** file. See the [Survey Components](survey-components.qmd) page for details on the main components in a surveydown survey. For a quick overview, here's how you add pages and questions:
