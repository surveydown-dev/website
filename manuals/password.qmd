...
You should first define your password on Supabase (see [Store Data](storing-data.qmd#create-a-supabase-project)). Then open your R console to your project folder and set this password with `sd_set_password()`.
...
1. Obtaining access to the Supabase database storing your survey data (see [Store Data](storing-data.qmd)).
2. Obtaining access to the [admin page](server-options.qmd#admin-page) of your survey.
