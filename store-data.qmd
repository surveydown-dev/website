...
The surveydown package is designed to work with any Postgres database. Since many may not want to create such a database on their own, we recommend using {{< var supabase >}}, which is a free, open-source Postgres database service.
