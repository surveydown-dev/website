...
| <i class="fa fa-random" aria-hidden="true"></i> | randomized-question-labels<br>[Access Demo](https://surveydown.shinyapps.io/random/) | A demo of how to implement [randomized question labels](reactivity.html#randomizing-question-labels). |
