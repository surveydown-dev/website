...
The [documentation](https://surveydown.org/documentation) has many more details on all of this, and later in this post I'll give a quick overview of a few of these features. But first, let me tell you a little about _why_ we decided to build surveydown.
...
After getting everything [installed](https://surveydown.org/manuals/installation), we recommend starting with a template survey project. To do so, run the following in the R console:
...
The `sd_question()` function can be used to create a variety of [question types](https://surveydown.org/manuals/questions), like text input, select drop down choices, and more by changing the `type` argument.
...
Once you are happy with your survey, you can deploy it live to any server of your choice. Since it's a shiny app, you can [deploy it to shinyapps.io](https://surveydown.org/manuals/deployment) for free!
