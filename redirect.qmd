...
We highly recommend you to watch the [video showcase](https://www.youtube.com/watch?v=Q4sQjkHm3do) and play with our [demo survey](https://github.com/surveydown-dev/demo-external-redirect), so that you can have a full understanding of how this works:

<center>
<a href="https://www.youtube.com/watch?v=Q4sQjkHm3do" class="btn btn-primary" role="button"> Video Showcase </a> <a href="https://github.com/surveydown-dev/demo-external-redirect" class="btn btn-primary" role="button"> Demo Survey </a>
</center>
...
To make reactive redirect work, you need to edit both in your **server chunk**, and your **survey body**. We'll use an example to explain the process. This is the same example in our [demo survey](https://github.com/surveydown-dev/demo-external-redirect).
