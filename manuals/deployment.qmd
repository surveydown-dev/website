...
2. You have set up a database connection to store survey responses (e.g. using {{< var supabase >}}) and have already stored the database credentials using the `sd_db_config()` function (see the [Storing Data](storing-data.qmd) page for details).
