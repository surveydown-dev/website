...
::: {.callout-tip}
**Please render the `.qmd` file before running the app.**

In these demos, we've defined `use_html = TRUE` in `sd_server()`. This will increase the page loading speed, but it requires the existence of the HTML file. Rendering the `.qmd` file can create the HTML.
:::
