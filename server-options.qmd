...
To systematically display the preset system messages and button text elements in a different language, the default language can be changed from "en" using a different country code.

For example, to use the integrated Spanish translations:
...
See the [System Translations](system_translations.qmd) page for more details on creating additional translations and customising individual wordings.
