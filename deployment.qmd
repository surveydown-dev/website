...
2. Your supabase project with its credentials defined in your survey `.qmd` file. See the [Store Data](store-data) page for details.
...
This is covered in [Store Data](store-data.qmd). I want to further mention that you don't need to actively create any table on your supabase project. In your `db` variable of your `.qmd` file, there is a `table_name` argument. Whatever name you define here will become the table name of your supabase:
