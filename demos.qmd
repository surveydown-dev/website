...
Quick description of each demo:
...
| <i class="fa fa-balance-scale" aria-hidden="true"></i> | choice-based-conjoint-buttons | A demo of how to implement a choice-based conjoint survey with surveydown using layout of buttons. |
| <i class="fa fa-balance-scale" aria-hidden="true"></i> | choice-based-conjoint-table | A demo of how to implement a choice-based conjoint survey with surveydown using layout of a table. |
