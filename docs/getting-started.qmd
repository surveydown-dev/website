...
Survey content is edited in the **survey.qmd** file. See the [survey.qmd](basic-components.html#survey.qmd-1) section in [Basic Components](basic-components.html) for details on the main components in a surveydown survey. For a quick overview, here's how you add pages and questions:
