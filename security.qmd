...
The default free service for hosting a surveydown survey is {{< var shinyapps >}}. **This free service is not HIPPA compliant**. According to the [Posit Documentation on Security and Compliance](https://docs.posit.co/shinyapps.io/guide/security_and_compliance/index.html) for {{< var shinyapps >}}:
...
This means that if you require a HIPPA compliant hosting service, we recommend that follow Posit's guidelines and deploy your own Posit Connect or Shiny Server Open Source instance.

## The data storage environment

We designed surveydown to be able to [store data](store-data.qmd) on any PostgreSQL database. This gives you flexibility on where you choose to store your data, and it is up to you to find a suitable host. 
