...
names(html_button_options) <- c(
  ...
  "**Option 1**<br>
   <img src='https://github.com/surveydown-dev/demos/blob/main/choice-based-conjoint/images/fuji.jpg?raw=true' width=100><br>
   **Type**: Fuji<br>
   **Price**: $ 2 / lb<br>
   **Freshness**: Average",

  "**Option 2**<br>
   <img src='https://github.com/surveydown-dev/demos/blob/main/choice-based-conjoint/images/pinkLady.jpg?raw=true' width=100><br>
    **Type**: Pink Lady<br>
    **Price**: $ 1.5 / lb<br>
    **Freshness**: Excellent",

  "**Option 3**<br>
    <img src='https://github.com/surveydown-dev/demos/blob/main/choice-based-conjoint/images/honeycrisp.jpg?raw=true' width=100><br>
    **Type**: Honeycrisp<br>
    **Price**: $ 2 / lb<br>
    **Freshness**: Poor"
)
