...
::: {.callout-note}
You can speed up survey content creation using keyboard shortcuts. Proceed to the [surveydown Gadgets for Page and Question Creation](/blog/2025-04-08-surveydown-gadgets/) blog post for a detailed walkthrough.
:::
