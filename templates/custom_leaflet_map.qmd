...
[<i class="fas fa-external-link-alt"></i> Open in New Tab](https://surveydown-custom-leaflet-map.hf.space){.template-button .m-1 style="width: 200px;"}
...
<iframe src="https://surveydown-custom-leaflet-map.hf.space" class="template-iframe"></iframe>
</div>
