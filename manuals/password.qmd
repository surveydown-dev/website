...
You should first define your password on Supabase (see [Store Data](store-data.qmd#create-a-supabase-project)). Then open your R console to your project folder and set this password with `sd_set_password()`.
