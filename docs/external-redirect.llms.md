...
We recommend you try out our [external redirect template](https://github.com/surveydown-dev/template_external_redirect) that showcases both static and reactive redirects so that you can have a full understanding of how this works:
