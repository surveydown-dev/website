...
The `sd_nav()` function allows you control over the labels using the `next_label` and `prev_label` arguments, e.g.:
...
Finally, you can also set the target page to navigate to using the `next_page` argument in case you want to send respondents to a different page. The default behavior is to send the respondent to the immediate next page.
