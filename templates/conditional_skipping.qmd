...
[<i class="fas fa-external-link-alt"></i> Open in New Tab](https://surveydown-conditional-skipping.share.connect.posit.cloud/){.template-button .m-1 style="width: 200px;"}
...
<iframe src="https://surveydown-conditional-skipping.share.connect.posit.cloud/" class="template-iframe"></iframe>
</div>
