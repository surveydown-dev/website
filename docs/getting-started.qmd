...
- [`default`](../templates/default.html) (default): A minimal template for starting from scratch.
- [`question_types`](../templates/question_types.html): A template showcasing all built-in [question types](/docs/question-types.html).
- [`questions_yml`](../templates/questions_yml.html): A template showcasing questions defined using a YAML file.
- [`conditional_display`](../templates/conditional_display.html): A template for the [conditional display](docs/conditional-logic.html#conditional-display-of-questions) feature.
- [`conditional_navigation`](../templates/conditional_navigation.html): A template for the [conditional navigation](docs/conditional-logic.html#conditional-navigation-of-pages) feature.
- [`random_options`](../templates/random_options.html): A template for creating [randomized](docs/randomization.html#live-randomization) survey options.
- [`random_options_predefined`](../templates/random_options_predefined.html): A template for creating [predefined randomized](docs/randomization.html#predefined-randomization) survey options.
- [`reactive_questions`](../templates/reactive_questions.html): A template for creating [reactive](docs/reactivity.html) survey questions.
- [`reactive_drilldown`](../templates/reactive_drilldown.html): A [reactive](docs/reactivity.html) question template, with latter question options defined from former selection.
- [`external_redirect`](../templates/external_redirect.html): A reactive question template with [redirectional](docs/external-redirect.html#reactive-redirect) links, accepting URL parameters.
- [`live_polling`](../templates/live_polling.html): A [reactive](docs/reactivity.html) question template of live-polling with responses shown as a bar chart.
- [`conjoint_buttons`](../templates/conjoint_buttons.html): A conjoint survey template with options shown in buttons.
- [`conjoint_tables`](../templates/conjoint_tables.html): A conjoint survey template, with option contents shown in a table.
- [`custom_leaflet_map`](../templates/custom_leaflet_map.html): A template of [custom leaflet map](docs/custom-questions.html#leaflet-map-example) question using `sd_question_custom()`.
- [`custom_plotly_chart`](../templates/custom_plotly_chart.html): A template of [custom plotly chart](docs/custom-questions.html#plotly-chart-example) question using `sd_question_custom()`.
