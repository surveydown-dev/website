...
Every surveydown survey is configured in two files: 
...
The YAML header is at the top of the `survey.qmd` file. It contains some basic settings that you shouldn't change:
